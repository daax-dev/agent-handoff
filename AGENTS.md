...
- Never edit files under `dist/` or generated migration artifacts by hand.
...
- write or edit code → `.claude/language.md` (formatting, linting, testing for TypeScript: server, CLI, and `ui/` React app)
