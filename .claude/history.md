...
Note: `.logs/` is gitignored in this repo. These logs are local working memory, not committed artifacts. Reference them in the PR body when a decision affects the change.
...
- Primary authorities: official vendor docs (MCP spec, A2A spec, SPIFFE, Bun, npm), NIST, CIS, SLSA, OWASP, official RFCs.
