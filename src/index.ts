...
server.tool(
  ...
  "Hand off a task to another AI coding agent (CLI spawn or A2A protocol). Returns a job ID for tracking.",
  {
    ...
    senderSpiffeId: z.string().optional().describe("SPIFFE ID of the sending agent; stored on the job for future SVID-based envelope verification (not yet enforced)"),
